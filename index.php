               ...
               <div id="container-forms">
                ...
                <form id="contact-form" class="form"  action="valida.php" method="POST">
                    ...
                    <div class="forms">
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn btn-start-order" id="btn-form" name ="btnlogin" value="send"><b>ENVIAR </b><div class="spinner-grow text-dark" role="status" style="margin-bottom:5px;margin-left:5px;width: 16px; height: 16px;">
                            </div></button>
                        </div>
                    </div>
                </form>
